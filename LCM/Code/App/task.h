...
/*BRIGHTNESS FROM (0-255) 0 IS THE DIMMEST AND 255 IS THE BRIGHTEST*/
#define   LIGHTBAR_BRIGHTNESS_1 		140			// High brightness value -- Stock (204)
#define   LIGHTBAR_BRIGHTNESS_2 		70			// Medium brightness value -- Stock (128)
#define   LIGHTBAR_BRIGHTNESS_3 		10			// Low brightness value -- Stock (30)
/*BRIGHTNESS FROM (0-9999) 9999 IS THE DIMMEST AND 0 IS THE BRIGHTEST*/
#define   MAIN_BRIGHTNESS_1				9999		// Low brightness value -- Stock (7000)
#define   MAIN_BRIGHTNESS_2				7000		// Medium brightness value -- Stock (4000)
#define   MAIN_BRIGHTNESS_3				0			// High brightness value -- Stock (0000)
